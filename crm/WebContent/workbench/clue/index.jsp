...
<script type="text/javascript">
	...
	$(function(){
		...
		$(".time").datetimepicker({
			...
			clearBtn : true,
			pickerPosition : "top-right" // 设置日历控件的显示位置。
		});
		...
		$("#createBtn").click(function(){
			$.get(
				"${pageContext.request.contextPath}/workbench/clue/create.do",
				function(json){
					// 重置表单
					$("#clueForm")[0].reset();
					// [{"id":"","name":""},{"id":"","name":""}]
		...
		$("#saveBtn").click(function(){
			// 发送ajax post请求，保存线索
			$.post(
				"${pageContext.request.contextPath}/workbench/clue/save.do",
				{
			...
			<div style="position: relative;top: 50px;">
				<table class="table table-hover">
					...
					<tbody>
						<tr>
							<td><input type="checkbox" /></td>
							<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='workbench/clue/detail.do?id=fb020b8297f24f0a80d98e9c99e046d8';">李彦宏先生</a></td>
							<td>百度</td>
							<td>010-84846003</td>
							<td>12345678901</td>
							<td>广告</td>
                        ...
                        <tr class="active">
                            <td><input type="checkbox" /></td>
                            <td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='workbench/clue/detail.do?id=e9dce809034e4d5db8ea4559b50b40a3';">马云先生</a></td>
                            <td>阿里巴巴</td>
                            <td>010-84846003</td>
                            <td>12345678901</td>
                            <td>广告</td>
