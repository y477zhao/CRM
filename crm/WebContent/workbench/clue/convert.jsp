...
<script type="text/javascript">
	$(function(){
		...
		$("#convertBtn").click(function(){
			if(window.confirm("确定要转换线索吗？")){
				if($("#isCreateTransaction").prop("checked")){
					// 提交表单
					$("#tranForm").submit();
				}else{
					// 发送传统请求
					window.location.href = "${pageContext.request.contextPath}/workbench/clue/convert.do?id=${param.clueId}";	
				}
			}
		});
	});
...
<body>
	...
	<div id="create-transaction2" style="position: relative; left: 40px; top: 20px; width: 80%; background-color: #F7F7F7; display: none;" >
		...
		<form action="workbench/clue/convert.do" method="post" id="tranForm">
			<%-- 线索id隐藏域 --%>
			<input type="hidden" name="id" value="${param.clueId}">
			<%-- 创建交易的标记 --%>
		  ...
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
		    ...
		    <input type="text" class="form-control" id="activity" name="activityId" placeholder="点击上面搜索" readonly>
		  </div>
		</form>
